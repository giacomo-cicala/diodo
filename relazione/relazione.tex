...
\begin{abstract}
	...
	L'esperimento ha avuto come obbiettivo la realizzazione di un circuito per la
...
\qty{1}{\kohm} e due diodi a giunzione p-n, uno al silicio (\err{codice
	diodo?}) e uno al germanio (\err{uguale}). La tensione ai capi del diodo e la
...
Per ricavare le caratteristiche I-V dei diodi si è realizato il secondo
...
\qty{0}{\mV} -- \qty{180}{\mV}. \err{spiega?}

\begin{figure}[h]
	\includegraphics[width=\textwidth]{caratteristica.pdf}
...
\begin{equation*}
	(I_{0})_{Ge} = ( 1 \pm 4 ) \ \unit{\uA} \hspace{2cm} (\eta V_{T})_{Ge} = (44 \pm 25) \ \unit{\mV}
\end{equation*}
