...
dovute principalmente a fenomeni di generazione termica e ricombinazione all'
interno della depletion region.
...
\cref{tab:data_silicio,tab:data_germanio} e \err{grafici}.
